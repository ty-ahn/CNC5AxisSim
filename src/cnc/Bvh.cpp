...
#include <cmath>
namespace cnc {
static Vec3 subb(Vec3 a,Vec3 b){return {a.x-b.x,a.y-b.y,a.z-b.z};}
static double dotb(Vec3 a,Vec3 b){return a.x*b.x+a.y*b.y+a.z*b.z;}
static Vec3 addb(Vec3 a,Vec3 b){return {a.x+b.x,a.y+b.y,a.z+b.z};}
