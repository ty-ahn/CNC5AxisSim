...
struct ToolGeometry {
 ToolShape shape{ToolShape::Flat}; double radius{2}; double corner_radius{0}; double length{100};
 double holder_radius{20}; double holder_length{80};
};
...
struct CollisionEvent { CollisionType type{}; Vec3 position{}; double penetration{}; bool collision{}; };
class Stock {
