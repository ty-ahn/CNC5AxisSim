...
struct ModalState{MotionMode motion{MotionMode::Rapid};bool absolute{true};int work_offset{54};int plane{17};int feed_mode{94};bool coolant{false}; bool traori{false}; int cycle{0}; int spindle_direction{0};};
class Runtime{
